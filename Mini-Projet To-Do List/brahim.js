...
let livres = [
    { id_livre: 1, titre: "The Great Gatsby", auteur: "F. Scott Fitzgerald", annee: 1925, disponible: "non" },
    { id_livre: 2, titre: "The Great Gatdksdsdsby", auteur: "F. Scsfsdfsdott Fitzgerald", annee: 19235, disponible: "oui" },
]; 
...
function ajouterLivre(){
    ...
    function afficherLivres(){
        ...
        for(let i in livres){
          console.log(`${livres[i].id_livre} - ${livres[i].titre} ${livres[i].auteur} - (${livres[i].annee}) - ${livres[i].disponible ? "Disponible" : "Non disponible"}`);
        }
        console.log();
    }
